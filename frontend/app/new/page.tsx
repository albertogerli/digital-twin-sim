...
const EXAMPLE_BRIEFS = [
  ...
  "Il MEF rinvia di 60 giorni il decreto attuativo sul piano \"Rete Unica\" — la fusione tra Open Fiber (CDP/Macquarie) e FiberCop/NetCo (KKR/TIM). Tensione interna: Giorgetti (MEF) chiede di rinegoziare le garanzie state-backed da €25 mld dato il vincolo di bilancio post-PNRR, mentre Urso (MIMIT) preme per chiudere entro il semestre di presidenza UE. KKR contesta tre clausole sui meccanismi di prezzo wholesale e minaccia revisione del piano di investimento da €11 mld. La DG Comp europea (Ribera) segnala in via informale possibili rilievi state-aid; Virkkunen (sovranità tecnologica) spinge invece per accelerare nel quadro del Digital Networks Act. Il Sole 24 Ore pubblica uno scoop su un dossier interno CDP; SLC-CGIL annuncia mobilitazione su rischi occupazionali. Bloomberg riporta TIM in calo nel pre-market. Simulare 9 turni: reazione di stakeholder politici, sindacali, finanziari (analyst Mediobanca/Equita, fintwit), industriali (Confindustria), commissari UE e media. Quale impatto su TIT.MI, spread BTP-Bund 10y, sector beta telecom EU (DTE.DE, ORA.PA, VOD.L, TEF.MC), e contagio cross-sector verso utilities (ENEL.MI, A2A.MI) e infrastrutture (TRN.MI).",
];
