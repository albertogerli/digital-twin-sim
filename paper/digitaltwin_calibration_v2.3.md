...
Total: 42 scenarios. 34 train / 8 test. 10 domains. 1 flagged NEEDS_VERIFICATION (Archegos). Verified polling available for 31 scenarios (polling from LLM estimation where sample_size is not verified). Median scenario length: 6 rounds.
