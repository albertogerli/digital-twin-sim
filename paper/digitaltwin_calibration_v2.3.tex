...
\title{Bayesian Calibration of LLM-Agent Opinion Dynamics:\\Hierarchical Inference, Sensitivity Analysis, and Online Assimilation}
...
\noindent\textbf{Keywords:} opinion dynamics, agent-based modeling, LLM agents, Bayesian calibration, variational inference, data assimilation
