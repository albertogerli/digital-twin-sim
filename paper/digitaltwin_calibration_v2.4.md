...
**Keywords:** opinion dynamics, agent-based modeling, large language models, Bayesian calibration, data assimilation, ensemble Kalman filter, digital twin, computational social science, multi-modal calibration, financial market linkage
